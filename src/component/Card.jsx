...
function Card({ content }) {
    ...
    return (
        <div className='w-auto lg:w-[400px]  px-4 flex flex-col justify-center rounded-lg drop-shadow-lg hover:drop-shadow-2xl hover:cursor-pointer'>
            ...
            <div className='flex flex-col justify-between mt-6 px-6 bg-[#FCE097] h-auto lg:h-[430px] p-4 relative -top-20 rounded'>
                <div className='mt-16'>
            ...
            <div className='font-Lilita-One lg:text-2xl relative -top-[100px] left-[190px] lg:left-[230px] md:left-[300px] bg-[#F0B91E] hover:border hover:border-[#D2272B] hover:animate-bounce text-center rounded w-fit p-2'>
                <a href={content.viewApp} target='blank' type='button'>View App</a>
            </div>
        </div>
    )
}
